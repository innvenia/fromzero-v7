...
<!-- FROMZERO_START_HERE:BEGIN managed=true version={{ADAPTER_VERSION}} app={{APP_NAME}} -->
...
| Proyecto | {{APP_NAME}} |
| Versión del adaptador FromZero | {{ADAPTER_VERSION}} |
...
> Activa el modo plan de {{APP_NAME}} antes de continuar.
