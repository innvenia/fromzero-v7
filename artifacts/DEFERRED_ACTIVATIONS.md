...
| Historial de estados | 2026-06-21: creado durante Fase 1 para registrar activaciones pendientes |
...
| Restricciones de seguridad | Sin secretos. Sin `.env` reales. Valores reales solo en secrets externos. |
...
| OpenRouter real | bloqueado por gate externo | Requiere revalidar modelo y costos antes de Sprint 9 | Modelo confirmado y secret externo |
